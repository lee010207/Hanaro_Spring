...
<head>
    ...
    <script>
        let logincheck = {
            init:function (){
                $(".userservice").click(()=>{
                    let loginId = '${logininfo.memberId}';
                    if(loginId == '' || loginId == null){
                        $(".userservice").removeAttr('href');
                        alert("로그인을 해주세요");
   ...
   <c:choose>
       <c:when test="${not empty logininfo}">
           <div class="topMenu d-none d-md-block container">
               <span>${logininfo.memberId}님</span>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<c:url value="/commu"/>">공지사항</a>
                        <a href="#">홍보자료</a>
                        <a href="#">채용안내</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-content">
                        <a class="userservice" href="<c:url value="/cust/onetoone"/>">1:1문의</a>
                        <a class="userservice" href="<c:url value="/cust/qna"/>">묻고답하기</a>
                        <a class="userservice" href="#">FAQ</a>
                    </div>
                </li>
            </ul>
        </div>

...
public class NcpUtil {
    public static String getSentimentDetail(JSONObject jsonObject){

        String result = (String) ((JSONObject)jsonObject.get("document")).get("sentiment");;
        return result;
    }
    public static JSONObject getSentiment(String ncpId, String ncpSecret, String text){
